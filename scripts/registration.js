if (document.readyState === 'loading') {
  if (document.URL.split('/').pop() == 'welcome') {
    document.addEventListener('DOMContentLoaded', translateRegistration);
  }
} else {
  // The DOMContentLoaded event already fired, run code immediately
  if (document.URL.split('/').pop() == 'welcome') {
